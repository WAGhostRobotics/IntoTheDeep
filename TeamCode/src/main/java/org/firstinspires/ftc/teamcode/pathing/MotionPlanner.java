...
//    public static PIDController translationalControlEnd = new PIDController(0.025,0.02,0.1);
    public static PIDController translationalControlEndX = new PIDController(0.02,0.0005,0);
    public static PIDController translationalControlEndY = new PIDController(0.01, 0, 0);
    public static PIDController headingControlEnd = new PIDController(0.02, 0.009, 0); // hope
    ...
    public static double kStatic_X = 0; //.19
